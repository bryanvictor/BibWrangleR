...
setwd("/Users/Bryan/Desktop/Git/manuscripts/coauth")
...
ggplot(DF, aes(total_cites)) +
  ...
  geom_segment(aes(x = 17, y = 217, xend = 6.5, yend = 217), 
               arrow = arrow(length = unit(0.25, "cm"))) +
  annotate("text", x = 23, y = 315, label = "median = 3", size = 4.5) +
  annotate("text", x = 27, y = 218, label = "3rd quartile = 5", size = 4.5) +
  annotate("text", x = 22.5, y = 490, label = "1st quartile = 1", size = 4.5)
...
years_active <- read.csv("years_active.csv")

DF <- left_join(DF, years_active)
